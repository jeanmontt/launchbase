...
Nesse desafio você deve atualizar os arquivos com informações de conteúdos e descrição de forma dinâmica.
...
#Entrar no diretório
$ cd launchbase/fase_02/03_inciando_back_end/desafio_03-2_nunjucks-e-dados-dinamicos
